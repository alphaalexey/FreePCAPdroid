...
public class MatchList {
    ...
    public static String getRuleLabel(Context ctx, RuleType tp, String value) {
        ...
        switch (tp) {
            case APP:
                resid = R.string.app_val;
                break;
            case IP:
                resid = R.string.ip_address_val;
                break;
            case HOST:
                resid = R.string.host_val;
                break;
            case PROTOCOL:
                resid = R.string.protocol_val;
                break;
            case COUNTRY:
                resid = R.string.country_val;
                break;
            default:
                return "";
        }
    ...
    public boolean addIp(String ip) {
        return addRule(new Rule(RuleType.IP, ip));
    }

    public boolean addHost(String info) {
        return addRule(new Rule(RuleType.HOST, Utils.cleanDomain(info)));
    }

    public boolean addProto(String proto) {
        return addRule(new Rule(RuleType.PROTOCOL, proto));
    }

    public boolean addCountry(String country_code) {
        return addRule(new Rule(RuleType.COUNTRY, country_code));
    }

    public boolean addApp(String pkg) {
        return addRule(new Rule(RuleType.APP, pkg));
    }
    ...
    public void removeIp(String ip) {
        removeRule(new Rule(RuleType.IP, ip));
    }

    public void removeHost(String info) {
        removeRule(new Rule(RuleType.HOST, Utils.cleanDomain(info)));
    }

    public void removeProto(String proto) {
        removeRule(new Rule(RuleType.PROTOCOL, proto));
    }

    public void removeCountry(String country_code) {
        removeRule(new Rule(RuleType.COUNTRY, country_code));
    }

    public void removeApp(String pkg) {
        removeRule(new Rule(RuleType.APP, pkg));
    }
